...
class TodoListTest < Minitest::Test
  ...
  def test_add_raise_error
    ...
    assert_raises(TypeError) { @list.add("ay")}
    assert_raises(TypeError) { @list.add(:rawr)}
  end
  ...
  def test_item_at
    assert_raises(IndexError) {@list.item_at(69)}
  ...
  def test_mark_done_at
    @list.mark_done_at(1)
    @todo2.done!
    assert_raises(IndexError) {@list.mark_done_at(69)}
    assert_equal(@todo2, @list.item_at(1))
  end
  ...
  def test_each2
    assert_equal(@list.each {|a| a}, @list)
  end
